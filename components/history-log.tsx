...
export default function HistoryLog({ onAtualizarEstacionamento }: HistoryLogProps) {
  ...
  const concluirSaida = async (caminhaoId: number) => {
    ...
    try {
      ...
      if (res.ok) {
        showToast("Sucesso", "Saída concluída com sucesso");
        ...
        showToast("Erro", resultado.error || "Falha ao concluir saída", "destructive");
      }
    } catch (err) {
      console.error("Erro inesperado:", err);
      showToast("Erro", "Erro inesperado ao concluir saída", "destructive");
    } finally {
